            ...
            <div id="home" className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-8 text-center">
                        ...
                        <hr />
                        <p>
                            I'm an aspiring <strong>machine learning scientist</strong>{" "}
                            and <strong>web developer</strong> based in Vancouver.
                        </p>
                        ...
                        <div className="social-icons-sect">
                            ...
                            <a href="https://www.linkedin.com/in/bang-chi-duong/" target="_blank"
